...
insights about the physical world with data science methods to privacy and security tailored to specific
sysmtems.

You can find more information about Professor Salinas Monroy's research [here](ADD LINK).
...
#### Detectinon of Integrity Attacks Detection in Space Situational Awareness Systems using Deep Learning
Project description goes here

**Useful skills to have for this project:** List a few skills that students need for this project. This
will help them make a case in their research interest when they talk about the skills they have. 

#### Detection of botnet netwroks traffic using deep neural networks
Project description goes here
...
Professor Yumi Suzuki from the School of Criminal Justice focuses on the use of
technology in criminal justice. Her research covers a verity of topics including ​cyber space
as a place for crime commission and victimization; investigative tools (e.g., surveillance and
evidence collection in physical and cyber space, databases, license plate reader)​; application
of technology to help cyber-crime victims (e.g., VINE, inmate release notification; secure reporting
system for DV victims) ​
...
#### Countering Deepfakes in Identity Management/Fraud
